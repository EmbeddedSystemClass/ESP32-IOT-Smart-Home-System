...
int connectClient(void)
{
    ...
    if ((error = CayenneMQTTSubscribe(&mqttClient, NULL, DATA_TOPIC, CAYENNE_ALL_CHANNELS, NULL)) != CAYENNE_SUCCESS) {
        ESP_LOGE(LOCAL_TAG, "Subscription to Data topic failed, error:%d\n", error);
    }
