...
COMPONENT_OBJS = $(MAIN_OBJS) $(CAYENNE_MQTT_CLIENT_OBJS) $(CAYENNE_UTILS_OBJS) $(MQTT_COMMON_OBJS) $(PLATFORM_OBJS) $(WIFI_OBJS) $(STORAGE_OBJS) $(HTTP_SERVER_OBJS) $(CAYENNE_OBJS)

COMPONENT_PRIV_INCLUDEDIRS := $(MAIN_DIR) $(CAYENNE_MQTT_CLIENT_DIR) $(CAYENNE_UTILS_DIR) $(MQTT_COMMON_DIR) $(PLATFORM_DIR) $(WIFI_DIR) $(STORAGE_DIR) $(HTTP_SERVER_DIR) $(CAYENNE_DIR)
COMPONENT_SRCDIRS := $(MAIN_DIR) $(CAYENNE_MQTT_CLIENT_DIR) $(CAYENNE_UTILS_DIR) $(MQTT_COMMON_DIR) $(PLATFORM_DIR) $(WIFI_DIR) $(STORAGE_DIR) $(HTTP_SERVER_DIR) $(CAYENNE_DIR)