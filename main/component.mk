...
COMPONENT_OBJS = main.o $(CAYENNE_MQTT_CLIENT_OBJS) $(CAYENNE_UTILS_OBJS) $(MQTT_COMMON_OBJS) $(PLATFORM_OBJS) $(WIFI_OBJS) $(STORAGE_OBJS) $(WEBSERVER_OBJS)

COMPONENT_PRIV_INCLUDEDIRS := . $(CAYENNE_MQTT_CLIENT_DIR) $(CAYENNE_UTILS_DIR) $(MQTT_COMMON_DIR) $(PLATFORM_DIR) $(WIFI_DIR) $(STORAGE_DIR) $(WEBSERVER_DIR)
COMPONENT_SRCDIRS := . $(CAYENNE_MQTT_CLIENT_DIR) $(CAYENNE_UTILS_DIR) $(MQTT_COMMON_DIR) $(PLATFORM_DIR) $(WIFI_DIR) $(STORAGE_DIR) $(WEBSERVER_DIR)